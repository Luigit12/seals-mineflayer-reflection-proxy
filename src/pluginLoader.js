...
function loadPlugins(server, player, bot, setPlayerControl) {
  const helpCommand = () => {
    player.write('chat', { message: JSON.stringify({ "text": "", extra: [{ text: "\[Proxy\] ", bold: true, color: "dark_red" }, { text: `Proxy Commands:` }] }), position: 1, sender: '00000000-0000-0000-0000-000000000000' })
